...
int Task_lteTurboDecode_b2(
    __v6148i8 softin2_x_B,__v6148i8 softin2_y_B ,__v6148i8 e_p_B,
    __v4096i8 state0_8, __v6148i16 alphain_N,
    __v4096i8 b_add_d1_index,__v4096i8 b_add_d2_index,
    __v2048i16 btemp_index1,__v2048i16 btemp_index2,
  ...
  b_add_d1_index = vsadd(b_add_d1_index,0,MASKREAD_OFF,8);  
  b_add_d2_index = vsadd(b_add_d2_index,0,MASKREAD_OFF,8);  
  btemp_index1 = vsadd(btemp_index1,0,MASKREAD_OFF,8*SW);  
  btemp_index2 = vsadd(btemp_index2,0,MASKREAD_OFF,8*SW);  
  ...
  */
  ...
  vbrdcst(a_B_tempindex,B-1,MASKREAD_OFF,length);  
  vbrdcst(a1_B,176,MASKREAD_OFF,B);
  vshuffle(a1_B,a_B_tempindex,a2_B,SHUFFLE_SCATTER,1);
  ...
  // for(short k=1; k<3;k++){
    ...
    */
    ...
    vshuffle(atemp1_8,btemp_index1,atemp,SHUFFLE_GATHER,length);
    // atemp1_8 = vsadd(atemp1_8, 0,MASKREAD_OFF,length);  //133
    vshuffle(atemp2_8,btemp_index2,atemp,SHUFFLE_GATHER,length);
    ...
    for(int i=0; i<SW; i++){
      ...
      vsgt(b_add_d1_index,ones,MASKREAD_OFF,MASKWRITE_ON,8);
      ...
      vsgt(b_add_d2_index,ones,MASKREAD_OFF,MASKWRITE_ON,8);
    ...
    vsgt(atemp1_8,atemp2_8,MASKREAD_OFF,MASKWRITE_ON,length);    //atemp1_8小于atemp2_8
    ...
    for(short i=0;i<SW;i++){
      ...
      if(k-2 - i*kminus >= 0){
        ...
        vbrdcst(a_B_tempindex,k-2 - i*kminus,MASKREAD_OFF,1);
  ...
  vreturn(a1_B,B, a2_B,B, a3_B,B, a4_B,B, a5_B,B, a6_B,B, a7_B,B, a8_B,B);
