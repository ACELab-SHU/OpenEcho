# ACE-ECHO Venus Gem5 model

This snapshot includes the Venus model used by ACE-ECHO 1.0. Start with [the platform guide](../../docs/GETTING_STARTED.md) and preserve the upstream licenses below.
